...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_components_markdown_editor__ = __webpack_require__(170);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_html_to_react__ = __webpack_require__(48);
    ...
    _createClass(EDMarkdownEditor, [{
        ...
        value: function onOpenTab(ev, tab) {
            ...
            if (tab === MDMarkdownPreviewTab && !/^\s*$/.test(this.state.value)) {
                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/api/v1/utility/markdown', { markdown: this.state.value }).then(this.applyHtml.bind(this));
            }
        }
    }, {
        key: 'onValueChange',
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'li',
                        { role: 'presentation',
                            className: __WEBPACK_IMPORTED_MODULE_2_classnames___default()({ 'active': this.state.currentTab === MDMarkdownPreviewTab }) },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'a',
                            { href: '#', onClick: function onClick(e) {
