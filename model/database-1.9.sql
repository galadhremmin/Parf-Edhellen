ALTER TABLE `auth_accounts` CHANGE `AccountID` `id` INT(5) UNSIGNED NOT NULL AUTO_INCREMENT, 
    ...
    CHANGE `ProviderID` `provider_id` INT(10) UNSIGNED NULL DEFAULT NULL, 
    ...
    CHANGE `Configured` `configured` TINYINT(1) NOT NULL DEFAULT '0', 
...
RENAME TABLE `auth_accounts` TO `account`;
...
RENAME TABLE `auth_accounts_groups` TO `account_role_rel`;
...
RENAME TABLE `auth_groups` TO `role`;
...
ALTER TABLE `auth_providers` ADD `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ADD `updated_at` DATETIME NULL;
RENAME TABLE `auth_providers` TO `authorization_provider`;
...
ALTER TABLE `language` CHANGE `ID` `id` INT(1) UNSIGNED NOT NULL AUTO_INCREMENT, 
    ...
    CHANGE `Invented` `invented` TINYINT(1) NOT NULL DEFAULT '0', 
...
ALTER TABLE `sentence` CHANGE `SentenceID` `id` INT(11) NOT NULL AUTO_INCREMENT, 
    ...
    CHANGE `Neologism` `neologism` BIT(1) NULL DEFAULT b'0', 
    CHANGE `Approved` `approved` BIT(1) NULL DEFAULT b'0', 
...
ALTER TABLE `sentence_fragment_inflection` ADD `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ADD `updated_at` DATETIME NULL;
RENAME TABLE `sentence_fragment_inflection` TO `sentence_fragment_inflection_rel`;
...
ALTER TABLE `translation` CHANGE `TranslationID` `id` INT(8) UNSIGNED NOT NULL AUTO_INCREMENT, 
    ...
    CHANGE `Uncertain` `uncertain` BIT(1) NULL DEFAULT b'0', 
...
ALTER TABLE `translation_group` CHANGE `TranslationGroupID` `id` INT(11) NOT NULL AUTO_INCREMENT, 
    ...
    CHANGE `Canon` `canon` BIT(1) NOT NULL DEFAULT b'0';
