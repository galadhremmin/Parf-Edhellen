...
import type {
    ...
    ITextState,
} from './TextComponents._types';

/**
 * Converts one transformation into paragraphs of text components, which the contribution
 * form turns back into an editable string.
 */
