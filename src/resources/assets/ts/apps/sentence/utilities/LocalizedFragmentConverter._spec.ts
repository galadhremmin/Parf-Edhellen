...
import {
    ...
    SentenceFragmentLocalizationLineMap
...
describe('apps/sentence/utilities/LocalizedFragmentConverter', () => {
    ...
    const LatinMap: SentenceFragmentLocalizationLineMap[] = JSON.parse(`[[[0]," ",[1]," ",[2]," ",[3]," ",[4],[5]]]`);
    const TengwarMap: SentenceFragmentLocalizationLineMap[] = JSON.parse(`[[[0,"\`C"]," ",[1,"1~M7T5"]," ",[2,"1U7Ew#6"]," ",[3,"1U7~M5"]," ",[4,"\`Cw#61E5$5"]," ",[5,"\u00c1"]]]`);
