...
const convert = (transformerName: string, textTransformation: ITextTransformation, //
    ...
    // start from a really small number to avoid clashes with contribution preview panes (where
    // fragments may have negative ids).
    let autoGeneratedId = -2147483648; // 1 << 31
