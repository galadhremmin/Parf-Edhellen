...
const UngweInflectionsDialog = (props: IProps) => {
    ...
    const _fetchInflections = useCallback(async () => {
        ...
        try {
            ...
            const url = inflectData.words.length > 0 //
        ...
        >
            ...
            {inflectionData && inflectionData.words.length > 0 && (
                <div>
                    <StaticAlert type="info" className="mt-0">
                        <TextIcon icon="info-sign" />{' '}
                        These inflections were generated by <a href="https://quettali.org" target="_blank" rel="noreferrer">Quettali</a> using 
                                ...
                                <tfoot>
                                    <tr>
                                        <td colSpan={3} className="text-end">
                                            {ungweUrl && <a className="btn btn-secondary" href={ungweUrl} target="_blank" rel="noreferrer">
