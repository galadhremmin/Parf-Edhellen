            ...
            {inflectionData && inflectionData.words.length > 0 && (
                <div>
                    <StaticAlert type="info" className="mt-0">
                        ...
                        These inflections were generated by <a href="https://www.ungwe.net" target="_blank">Quettali</a> using 
                                ...
                                <tfoot>
                                    <tr>
                                        <td colSpan={3} className="text-end">
                                            <a className="btn btn-secondary" href={ungweUrl} target="_blank">
