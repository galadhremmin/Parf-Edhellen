...
<p>
  What you're looking for doesn't exist in our dictionary but it can be found by visiting {{ $lexical_entry_group->name }}.
...
<p>
    ...
    <a class="btn btn-primary" href="{{ $external_url }}" target="_blank">Visit {{ $lexical_entry_group->name }}</a>
</p>
