...
<div class="card shadow-lg mb-3">
  <div class="card-body">
    ...
    <ol>
      <li>You submit as much information about your lexical entry or phrase as possible via the forms below.</li>
    ...
    <div class="text-center">
      <a href="{{ route('contribution.create', ['morph' => 'lexical_entry']) }}" class="btn btn-primary">Add entry</a>
