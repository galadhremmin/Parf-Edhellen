<div class="alert alert-info">
  <p>
    <strong><span class="glyphicon glyphicon-info-sign"></span> Log in to record your progress!</strong>
    ...
    <a href="{{ route('login', ['redirect' => route('flashcard')]) }}">Log in and start over</a>.
  </p>
</div>
