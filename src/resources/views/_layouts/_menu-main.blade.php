<div class="container">
  ...
  <div class="navbar-collapse" id="main-menu-content">
    <ul class="navbar-nav me-auto">
      ...
      <li class="nav-item">
        <a class="nav-link {{ active(['practice', 'flashcard', 'flashcard.cards', 'word-finder.index', 'word-finder.show', 'crossword.index', 'crossword.calendar', 'crossword.play']) }}" href="{{ route('practice') }}">@lang('practice.title')</a>
      </li>
      <li class="nav-item">
