<?php
  ...
  class PageProfileModel {
    ...
    public function __construct() {
      ...
      $author->nickname = StringWizard::preventXSS($author->nickname);
      $author->tengwar  = StringWizard::preventXSS($author->tengwar);
      ...
      if ($this->_loggedIn) {
        ...
        $authorForAccount->profile = StringWizard::preventXSS($author->profile);
      }
      
      // Replace _markup_ with <em>html</em>.
      $author->profile = StringWizard::createLinks($author->profile);
